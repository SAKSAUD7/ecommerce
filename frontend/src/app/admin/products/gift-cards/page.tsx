  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-[20px] font-bold tracking-tight text-[#1a1a1a]">Gift Cards</h1>
          <p className="text-[#6d7175] text-sm mt-1">Manage and issue gift cards.</p>
        </div>
      </div>
      
      <div className="bg-white border border-[#e1e3e5] rounded-lg shadow-sm p-12 text-center">
        <h3 className="text-lg font-medium text-[#1a1a1a] mb-2">Gift Cards is coming soon</h3>
